      ...
      <section id="trainers" className="bg-[#0A0A0A] text-white py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <motion.div {...fadeInLeft} whileHover={{ scale: 1.02 }} transition={{ duration: 0.6 }} className="relative aspect-[3/4] overflow-hidden bg-white/[0.03] p-3 border border-[#C9A961]/20">
              <div className="relative w-full h-full overflow-hidden">
                <Image src="/debbie-new.jpg" alt="Debbie" fill className="object-cover" />
              </div>
            </motion.div>
            <motion.div {...fadeInRight}>
              ...
              <div className="space-y-4 text-white/70 leading-relaxed mb-8">
                ...
                <p>Passionate about guiding practitioners at the start of their journey, Debbie focuses on building safe, confident clinicians who understand not just how to perform treatments, but how to care for their clients properly, with a strong emphasis on ethics, patient safety, and natural, balanced results.</p>
              </div>
              <div className="flex flex-wrap gap-2 mb-6">
